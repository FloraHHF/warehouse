...
int main(int argc, char **argv)
{
    ...
    while (ros::ok()){
        ...
        cout << " Enter: 0 for arm, 1 for takeoff,2 for goal position " << endl;
        cin >> start_flag;
        ...
        if (start_flag == 1)
        {
            ...
            command_pub.publish(swarm_command);
            cout << " Takeoff command sent" << endl;
        }

        if (start_flag == 2)
        {
            cout << " Enter: desired x, y, z and yaw " << endl; 
            cin >> state_desired[0];
            cin >> state_desired[1];
            cin >> state_desired[2];
            cin >> state_desired[3];
